...
This file is kept only as an imported duplicate from the original brief. The canonical project brief is now [PROJECT.md](PROJECT.md).

Do not edit this file for product decisions or implementation scope.
